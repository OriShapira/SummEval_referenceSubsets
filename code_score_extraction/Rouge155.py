...
class Rouge155(object):
    ...
    # ORI HERE
    def add_rouge_args_to_default(self, extraArgs):
        """
        Add the given args to the default arguments of pyrouge.
        Pass in a list of arguments (e.g. ['-l', 100] for word length truncation of 100 words).
        """
        #if self.extraArgs == None:
